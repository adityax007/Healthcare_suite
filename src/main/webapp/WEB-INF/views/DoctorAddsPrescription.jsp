...
<%@ include file="/resources/static/navbar.jsp"%>
  ...
  <div class="jumbotron">
        ...
        <form  action="/edu/addPrescription.htm" method="post">
         <table id="booking">
          <tr>
            <th>Patient Name</th>
            <th>Symptom</th>
          ...
          <tr>
            <td><input type="text" name="patientSymptom" value ="${a.patient_name}" readonly ></td>    
		    ...
		    <td><input type="submit" name="patient" class="form-control" value="Add Prescription" ></td>
		    <td><input type="hidden" id="${count.count}" name="symptomId" value="${a.symptomId}"/> </td>
		    </tr>
		  </c:forEach>
        </table>  
        </form>
